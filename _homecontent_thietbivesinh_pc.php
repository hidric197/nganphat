<!--cid:382-rid:3-->
<div id="catalog-382" class="box-catalog">
	<div class="box-cat-bar">
		<div class="box-cat-title">
			<h2>
				<a href="<?=Common::$_GROUP_THIET_BI_VE_SINH?>"
					data-ssid="3820do-gia-dung" title="Thiết bị vệ sinh">Thiết bị vệ
					sinh</a>
			</h2>
		</div>
	...
	<div class="cat-product-highlight">
		<div class="title-bar-hl">
			<div class="title-bar-left">Thiết bị vệ sinh nổi bật</div>
			<div class="title-bar-right">
				<a href="<?=Common::$_GROUP_THIET_BI_VE_SINH_NOI_BAT?>"
					title="Thiết bị vệ sinh nổi bật">Xem tất cả sản phẩm</a>
			</div>
		</div>
		<div class="list-product-highlight spotlight-products"
			id="spotlight-prod-3" data-spotlight="3" data-start="7"
			data-pagenum="1" data-pages="7" data-max="30" data-length="5"
			data-maxpage="6">
			<ul class="owl-carousel product-highlight-wrap" data-pagecount="6"
        		...
        		?>
				<li class="product-highlight-item prod-item " data-pid="53088">
					<?php 
					   if ($row['product_down_price'] > 0) {
    				?>
					<div
...
<!-- 			<nav> -->
<!-- 				<div class="arrow-preview-product" data-page="7"> -->
