			...
			<div class="row-slogan">
				<div class="slogan-item">
					<a href="bao-hanh-san-pham" target="_blank"> <span> 
						<span class="icon-slogan"> 
							<img height="60px" class="lazy-img" src="template/images/Cam-ket-chinh-hang.png"
				...
				<div class="slogan-item">
					<a href="trung-tam-ho-tro" target="_blank"> <span> 
						<span class="icon-slogan"> 
							<img height="60px" class="lazy-img" src="template/images/Chiet-khau-hap-dan.png"
				...
				<div class="slogan-item">
					<a href="chinh-sach-giao-hang" target="_blank">
						<span> 
							<span class="icon-slogan"> 
								<img height="60px" class="lazy-img"
...
<a href="#" id="scrolltop" data-mobile="0"
	data-isadmin="0"><i class="fa fa-chevron-up"></i></a>
<footer id="footer-m">
	<div class="wrap">
