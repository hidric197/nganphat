<div id="catalog-263" class="box-catalog">
	<div class="box-cat-bar">
		<div class="box-cat-title">
			<h2>
				<a href="<?=Common::$_GROUP_THIET_BI_NHA_BEP?>"
					data-ssid="2630do-the-thao" title="Thiết bị nhà bếp">Thiết bị nhà bếp</a>
			</h2>
		</div>
	...
	<div class="cat-product-highlight">
		<div class="title-bar-hl">
			...
			<div class="title-bar-right">
				<a href="<?=Common::$_GROUP_THIET_BI_NHA_BEP_NOI_BAT?>"
					title="Thiết bị nhà bếp nổi bật">Xem tất cả sản phẩm</a>
			</div>
		</div>
		<div class="list-product-highlight spotlight-products"
			id="spotlight-prod-4" data-spotlight="4" data-start="12"
			data-pagenum="1" data-pages="12" data-max="30" data-length="5"
			data-maxpage="6">
			<ul class="owl-carousel product-highlight-wrap" data-pagecount="6"
        		...
        		?>
				<li class="product-highlight-item prod-item " data-pid="70936">
					<?php 
					   if ($row['product_down_price'] > 0) {
    				?>
					<div
