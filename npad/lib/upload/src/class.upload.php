...
class Upload
{
     ...
     * with Fileinfo PECL extension.
     * On some systems, Fileinfo is known to be buggy, and you
    ...
    function upload($file, $lang = 'en_GB')
    {
        ...
        if (empty($this->log)) {
            ...
            $supported = trim((in_array('png', $this->image_supported) ? 'png' : '') . ' ' . (in_array('webp', $this->image_supported) ? 'webp' : '') . ' ' . (in_array('jpg', $this->image_supported) ? 'jpg' : '') . ' ' . (in_array('gif', $this->image_supported) ? 'gif' : '') . ' ' . (in_array('bmp', $this->image_supported) ? 'bmp' : ''));
     ...
     * @access public
     * @param boolean $full
     *            Optional flag to get precise version
     ...
     * @access private
     * @param string $size
     *            Size in bytes, or shorthand byte options
     ...
     * @access private
     * @param mixed $offsets
     *            Offsets, as an integer, a string or an array
     * @param integer $x
     *            Reference picture width
     * @param integer $y
     *            Reference picture height
     * @param boolean $round
     *            Round offsets before returning them
     * @param boolean $negative
     *            Allow negative offsets to be returned
     ...
     *            Height
     * @param boolean $fill
     *            Optional flag to draw the background color or not
     * @param boolean $trsp
     *            Optional flag to set the background to be transparent
     ...
     *            Source height
     * @param int $pct
     *            Optional percentage of the overlay, between 0 and 100 (default: 100)
     * @return resource Destination image
     */
     ...
     *            Optional path location of the uploaded file, with an ending slash
